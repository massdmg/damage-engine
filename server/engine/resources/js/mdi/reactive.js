    ...
    if ($ != null) {
      ...
      rxt.mktag = mktag = function(tag) {
        return function(arg1, arg2) {
          ...
          _ref = (arg1 == null) && (arg2 == null) ? [{}, null] : arg1 instanceof Object && (arg2 != null) ? [arg1, arg2] : _.isString(arg1) && (arg2 != null) ? [mkAtts(arg1), arg2] : (arg2 == null) && _.isString(arg1) || arg1 instanceof Element || arg1 instanceof RawHtml || arg1 instanceof $ || _.isArray(arg1) || arg1 instanceof ObsCell || arg1 instanceof ObsArray ? [{}, arg1] : [arg1, null], attrs = _ref[0], contents = _ref[1];
          elt = $("<" + tag + "/>");
          ...
          if (contents != null) {
            toNodes = function(contents) {
              ...
              for (_j = 0, _len1 = contents.length; _j < _len1; _j++) {
                child = contents[_j];
                if (child == null) {
                  _results.push(document.createTextNode(""));
        ...
        if (_.isString(type)) {
          switch (type) {
            ...
            default:
              if (value instanceof rx.ObsCell) {
                return value.get();
              } else if (value instanceof rx.ObsArray || value instanceof rx.ObsMap) {
                return value.all();
              } else {
                return value;
              }
